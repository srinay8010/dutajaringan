...
jQuery(function () {
  jQuery(".checkbox-filter")
    ...
    .on("change", function () {
      ...
      if (!selected.length) {
        jQuery(".card-product .product-item").show();
        return;
      }
      jQuery(".card-product .product-item").hide();
      jQuery(".card-product .product-item").each(function () {
        const category = jQuery(this).attr("data-product");
